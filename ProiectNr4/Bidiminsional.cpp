...
//  double Media(int a[][DAYS]);
void Interschimbare(int a[][DAYS]);
void Adaugare(int a[][DAYS]);
void Sortare(int a[][DAYS], int ordine);
// void Rotire(int a[][DAYS], int optiune, int k);
void InserareColoana(int &n, int a[], int val, int pos);
...
int main()
{
    ...
    {
        system("cls");
        cout << "Proiect nr.4 elaborat de Smoleac Mihai" << endl;
        ...
        cout << "3. De modificat o linie sau o coloana" << endl;
        cout << "4. Sortare" << endl;
        ...
        case 5:
            ...
            //     cin >> poz;
            //     Inserare(temperature, temperatura, poz);
            ...
            //     cin >> temperatura;
            //     if ((poz = Cautare(temperature, temperatura)) < n)
            //     {
            //         Stergere(temperature, poz);
            //     }
        ...
        case 6:
            ...
            //     Clasificare(temperature);
            //     Clasificare2(temperature);
            break;
        }
        _getch();
    } while (optiune);
